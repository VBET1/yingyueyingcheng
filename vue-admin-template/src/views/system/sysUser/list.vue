<template>
  <div class="app-container">
    ...
    <div class="tools-div">
      ...
      <el-button class="btn-add" size="mini" :disabled="$hasBP('bnt.sysUser.remove') === false" @click="batchRemove()">批量删除</el-button>
    </div>
    <!-- 列表 -->
    <el-table
    ...
    >
      ...
      <el-table-column label="操作" align="center" fixed="right">
        <template slot-scope="scope">
          <el-button type="primary" icon="el-icon-edit" size="mini" title="修改" :disabled="$hasBP('bnt.sysUser.update') === false" @click="edit(scope.row.id)" />
          <el-button type="danger" icon="el-icon-delete" size="mini" title="删除" :disabled="$hasBP('bnt.sysUser.remove') === false" @click="removeDataById(scope.row.id)" />
          <el-button type="warning" icon="el-icon-baseball" size="mini" title="分配角色" :disabled="$hasBP('bnt.sysUser.assignRole') === false" @click="showAssignRole(scope.row)" />
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog title="添加/修改" :visible.sync="dialogVisible" width="40%">
      <el-form ref="dataForm" :model="sysUser" label-width="100px" size="small" style="padding-right: 40px">
        <el-form-item label="用户名" prop="username">
          <el-input v-model="sysUser.username" /></el-form-item>
        <el-form-item v-if="!sysUser.id" label="密码" prop="password">
          <el-input v-model="sysUser.password" type="password" /></el-form-item>
        <el-form-item label="姓名" prop="name">
          <el-input v-model="sysUser.name" /></el-form-item>
...
export default {
  ...
  methods: {
    ...
    fetchData(page = 1) {
      ...
      api.getUserPageInfo(this.page, this.limit, this.searchObj)
        .then((response) => {
