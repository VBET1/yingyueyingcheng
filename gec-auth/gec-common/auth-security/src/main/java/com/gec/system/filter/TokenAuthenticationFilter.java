...
public class TokenAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
        ...
        //如果是登录接口，直接放行
//        ("/admin/system/index/login".equals(request.getRequestURI())||
...
//                "/admin/system/upload/uploadVideo".equals(request.getRequestURI()))
        if("/admin/system/index/login".equals(request.getRequestURI())||
                "/admin/system/upload/uploadImage".equals(request.getRequestURI())||
                "/admin/system/upload/uploadVideo".equals(request.getRequestURI())
                ||"/admin/system/sysPlay/getAllPlayAuth".equals(request.getRequestURI())
                ||"/admin/system/sysPlay/getPlayAuthById".equals(request.getRequestURI())
                ||"/admin/system/sysPlay/getPlayAuthByNameSort".equals(request.getRequestURI())
        )  {
