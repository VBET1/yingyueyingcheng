...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers("/admin/system/sysPlay/getAllPlayAuth").permitAll()
                .antMatchers("/admin/system/sysPlay/getPlayAuthById").permitAll()
                .antMatchers("/admin/system/sysPlay/getPlayAuthByNameSort").permitAll()
                // 这里意思是其它所有接口需要认证才能访问
